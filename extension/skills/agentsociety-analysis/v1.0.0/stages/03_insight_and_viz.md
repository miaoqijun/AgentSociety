...
7. Keep generated code and chart outputs under `$CHARTS_DIR`. Name atomic chart files according to `references/output-conventions.md`, for example `chart_{nn}_{description}.png`.
