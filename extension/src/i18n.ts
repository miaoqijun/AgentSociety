...
const translations: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    'projectStructure.skillManagement.tooltip': '安装与市场浏览；开关控制是否加载，关闭不删源文件',
  ...
  'en-US': {
    ...
    'projectStructure.skillManagement.tooltip': 'Install and browse marketplace; toggles control loading without deleting files',
