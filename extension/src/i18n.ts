...
const translations: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    'projectStructure.topicFile.description': '点击预览',
    'projectStructure.topicFile.tooltip': '预览 TOPIC.md；如需编辑，请右键选择在编辑器中打开',
    ...
    'projectStructure.reportChartsTooltip':
      '分析过程生成的图片、表格与 JSON 等（含工具子目录）。进程状态请查看实验 run 目录。悬停文件可查看完整路径。',
  ...
  'en-US': {
    ...
    'projectStructure.topicFile.description': 'Click to preview',
    'projectStructure.topicFile.tooltip': 'Preview TOPIC.md; to edit it, right-click and open it in the editor',
    ...
    'projectStructure.reportChartsTooltip':
      'Plots, tables, and JSON from analysis (including tool subfolders). For run status see the experiment run folder. Hover a file for its full path.',
