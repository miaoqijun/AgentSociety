...
const translations: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    'extension.replay.inputHypothesis': '请输入假设编号（一般与文件夹 hypothesis_ 后的数字一致）',
    'extension.replay.inputHypothesisPlaceholder': '例如：1',
    'extension.replay.inputExperiment': '请输入实验编号（一般与文件夹 experiment_ 后的数字一致）',
    ...
    'extension.literatureIndex.missing': '找不到文献索引文件，请确认工作区中 papers/literature_index.json 存在。',
    'extension.literatureIndex.openFailed': '无法打开文献索引预览，请稍后重试。',
    'extension.steps.noWorkspace': '请先打开工作区文件夹。',
    'extension.steps.notFound': '当前工作区中未找到步骤配置文件（init/steps.yaml）。',
    ...
    'extension.experimentResults.notFound': '未找到实验结果文件（run/experiment_results.json）。若尚未跑过实验，请先运行实验。',
    ...
    'extension.pid.missing': '找不到进程状态文件，请从实验节点下的 pid.json 打开。',
  ...
  'en-US': {
    ...
    'extension.replay.inputHypothesis': 'Enter hypothesis ID (usually the number after hypothesis_)',
    'extension.replay.inputHypothesisPlaceholder': 'e.g. 1',
    'extension.replay.inputExperiment': 'Enter experiment ID (usually the number after experiment_)',
    ...
    'extension.literatureIndex.missing': 'Literature index file was not found. Ensure papers/literature_index.json exists in the workspace.',
    ...
    'extension.steps.notFound': 'No steps file found (init/steps.yaml) in this workspace.',
    ...
    'extension.experimentResults.notFound': 'No experiment results file found (run/experiment_results.json). Run an experiment first if you have not.',
    ...
    'extension.pid.missing': 'Process status file not found. Open it from the pid.json item under your experiment.',
