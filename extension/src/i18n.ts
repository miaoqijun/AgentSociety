...
const translations: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    'projectStructure.presentation.tooltip': '展开查看按假设和实验生成的分析报告',
    ...
    'projectStructure.paperWorkspace': '论文工作区',
    'projectStructure.paperWorkspace.tooltip': 'paper-toolkit 产物目录',
    'projectStructure.paperState': '工作区状态',
    'projectStructure.evidenceGraph': '证据图谱',
    'projectStructure.researchPack': '研究扫描包',
    ...
    'projectStructure.analysisWorkspace': '分析管线',
    'projectStructure.analysisWorkspace.tooltip': 'paper-toolkit 分析管线产物',
    'projectStructure.analysisExperiment': '分析实验',
    'projectStructure.analysisClaims': '分析结论',
    'projectStructure.analysisEda': '探索性分析',
    'projectStructure.analysisContext': '报告上下文',
    'projectStructure.analysisSynthesis': '综合摘要',
  },
  'en-US': {
    // extension.ts
    ...
    'projectStructure.presentation.tooltip': 'Expand to view analysis reports organized by hypothesis and experiment',
    ...
    // projectStructureProvider.ts - paper-toolkit workspace
    'projectStructure.paperWorkspace': 'Paper Workspace',
    'projectStructure.paperWorkspace.tooltip': 'paper-toolkit artifacts',
    'projectStructure.paperState': 'Workspace State',
    'projectStructure.evidenceGraph': 'Evidence Graph',
    'projectStructure.researchPack': 'Research Pack',
    ...
    'projectStructure.analysisWorkspace': 'Analysis Pipeline',
    'projectStructure.analysisWorkspace.tooltip': 'paper-toolkit analysis pipeline artifacts',
    'projectStructure.analysisExperiment': 'Analysis Experiment',
    'projectStructure.analysisClaims': 'Claims',
    'projectStructure.analysisEda': 'EDA',
    'projectStructure.analysisContext': 'Report Context',
    'projectStructure.analysisSynthesis': 'Synthesis Brief',
  },
};
